...
gulp.task("vendor:bootstrap-slider:sass", function () {
    return pipe(gulp.src("./node_modules/bootstrap-slider/src/sass/**/*.*"),
        [gulp.dest("./src/vendor/bootstrap-slider/scss")])
        .on('error', gutil.log);
});
gulp.task("vendor:bootstrap-slider:js", function () {
     return pipe(gulp.src("./node_modules/bootstrap-slider/dist/bootstrap-slider.js"),
        [gulp.dest("./src/vendor/bootstrap-slider/js")])
        .on('error', gutil.log);
});
